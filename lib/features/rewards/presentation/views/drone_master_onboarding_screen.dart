...
class DroneMasterOnboardingScreen extends StatelessWidget {
  const DroneMasterOnboardingScreen({super.key});
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Positioned(
                                  child: Assets.svgs.badgeLevel3.svg(),
                                ),
                                Positioned(
                                  top: nilDotNil,
                                  left: twentyDotNil,
                          ...
                          // Title
                          Text(
                            context.localize.youveUnlockedDroneMaster,
                          ...
                          Text(
                            context.localize
                                .youveReachedTheHighestLevelThisSeasonKeepGoingToStayOnTopOfTheLeaderboardAndPrepareForNewChallengesInTheNextSeason,
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                              color: hex626262,
