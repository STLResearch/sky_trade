...
base class TrackedDroneInsightsEntity extends Equatable {
  const TrackedDroneInsightsEntity({
...
base class FilteredDroneInsightsEntity extends Equatable {
  const FilteredDroneInsightsEntity({
