...
mixin _$Web3AuthRegisterState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserEntity userEntity) registered,
    required TResult Function(
            Web3AuthAuthenticationFailure web3AuthAuthenticationFailure)
        failedToRegister,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserEntity userEntity)? registered,
    TResult? Function(
            Web3AuthAuthenticationFailure web3AuthAuthenticationFailure)?
        failedToRegister,
  }) =>
...
class _$RegisteredImpl implements _Registered {
  const _$RegisteredImpl({required this.userEntity});
  ...
  @override
  String toString() {
    return 'Web3AuthRegisterState.registered(userEntity: $userEntity)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return registered?.call(userEntity);
  }
...
abstract class _Registered implements Web3AuthRegisterState {
  const factory _Registered({required final UserEntity userEntity}) =
      _$RegisteredImpl;
