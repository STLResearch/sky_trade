...
const southWestLatitudeKey = 'southWestLat';
const southWestLongitudeKey = 'southWestLng';
const northEastLatitudeKey = 'northEastLat';
const northEastLongitudeKey = 'northEastLng';
